...
jQuery(document).ready(function ($) {
    $("#spig").mousedown(function (e) {
        if(e.which==3){
        showMessage("秘密通道:<br /><a href=\"http://feed.80wow.com/\" title=\"订阅\">订阅</a>    <a href=\"http://blog.80wow.com\" title=\"首页\">首页</a>",10000);
}
});
...
jQuery(document).ready(function ($) {
    if (isindex) { //如果是主页
        ...
        showMessage('欢迎' + visitor + '来到80wow blog《' + title + '》', 6000);
    }
    $(".spig").animate({
...
jQuery(document).ready(function ($) {
    ...
    $(".top-cate").mouseover(function(){
        showMessage('去 <span style="color:#0099cc;">' + $(this).text() + '</span> 逛逛');
    })
    $(' dl dd a').mouseover(function () {
        showMessage('要看看《<span style="color:#0099cc;">' + $(this).text() + '</span>》这篇文章么？');
    });
    $('.top-nav-wrap ul li a').mouseover(function () {
        showMessage('点击查看 <span style="color:#0099cc;">' + $(this).text() + '</span> 分类下得所有文章');
    });
    $('.read a').mouseover(function () {
        showMessage('点击阅读文章，让你收获知识！');
    });
    $(".search-content").mouseover(function(){
...
jQuery(document).ready(function ($) {
    ...
    window.setInterval(function () {
        ...
        msgs = ["播报明日天气<iframe name=\"xidie\" src=\"http://i.tianqi.com/index.php?c=code&id=99\" frameborder=\“0\” scrolling=\"no\" height=\"15px\"  width=\"130px\" allowtransparency=\"true\" ></iframe>", "陪我聊天吧！", "<a href=\"/15.html\" target=\"_blank\" rel=\"external\" tip=\"Feed\"><img border=\"0\" title=\"订阅乱了感觉\" alt=\"Feed\" src=\"/App/Modules/Home/Public/spig/rss.jpg\"></a>", "好无聊哦，你都不陪我玩！", "…@……!………", "^%#&*!@*(&#)(!)(", "我可爱吧！嘻嘻!~^_^!~~","谁淫荡呀?~谁淫荡?，你淫荡呀!~~你淫荡！~~","从前有座山，山上有座庙，庙里有个老和尚给小和尚讲故事，讲：“从前有座……”"];
        var i = Math.floor(Math.random() * msgs.length);
...
jQuery(document).ready(function ($) {
    window.setInterval(function () {
        //src=\"/15.html\"
        msgs = ["播报明日天气<iframe name=\"xidie\" src=\"http://i.tianqi.com/index.php?c=code&id=99\" frameborder=\“0\” scrolling=\"no\" height=\"15px\"  width=\"130px\" allowtransparency=\"true\" ></iframe>", "快快订阅我的博客吧！<a href=\"/15.html\" target=\"_blank\" rel=\"external\" tip=\"Feed\">订阅</a>", "乾坤大挪移！", "我飘过来了！~", "我飘过去了", "我得意地飘！~飘！~"];
        var i = Math.floor(Math.random() * msgs.length);
